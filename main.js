...
import router from './common/bobo-router'
import Utals from "./common/utals/base"
import cuCustom from './colorui/components/cu-custom.vue'

Vue.component('cu-custom',cuCustom)


Vue.prototype.Utals = new Utals()
Vue.prototype.eventBus = new Vue()

Vue.prototype.toLiveing = function(id) {
...
Vue.prototype.toPage = function(url, params) {
	this.$Router.push({
		page: url,
		params: params
	})
...
// 全局配置
request.setConfig({
  baseUrl: 'http://111.229.100.131/index.php/', // 此为测试地址，需加入到域名白名单，或者更改为您自己的线上地址即可
...
Vue.prototype.back = function(traget) {
